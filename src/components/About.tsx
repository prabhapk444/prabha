        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <figure className="relative group">
              <img
                src={imageSrc}
                alt="Prabhakaran S, General Manager at Thrive Boost, smiling and professionally dressed."
                loading="lazy"
                className="rounded-lg shadow-xl transform group-hover:scale-105 transition-transform duration-300"
              />
              <div
                aria-hidden="true"
                className="absolute inset-0 rounded-lg bg-primary-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              />
            </figure>
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                General Manager at Thrive Boost, passionate about creating
                innovative solutions that make a difference. With expertise in
                full-stack development and a keen eye for design, I bring ideas
                to life through clean, efficient code.
              </p>
              <p className="text-gray-600 dark:text-gray-300">
                When I'm not coding, you'll find me exploring new technologies,
                playing cricket, or enjoying music. I believe in continuous
